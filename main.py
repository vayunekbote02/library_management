...
# Variables
lf_bg = '#2a2b2e'  # Left Frame Background Color
rtf_bg = '#eff1f3'  # Right Top Frame Background Color
rbf_bg = '#bfab25'  # Right Bottom Frame Background Color
btn_hlb_bg = '#ba5624'  # Background color for Head Labels and Buttons
...
Label(root, text='LIBRARY MANAGEMENT SYSTEM', font=("Noto Sans CJK TC",
      15, 'bold'), bg=btn_hlb_bg, fg='White').pack(side=TOP, fill=X)
